...
void* my_malloc(int numBytes) {
    ...
    // search for [numPages] contiguous free pages to allocate
    int i = 0;
    while (currHeader) {
...
int my_free(void *ptr) {
    ...
    pageHeaderList.numPagesAllocated -= firstHeader->numPagesInSection;
